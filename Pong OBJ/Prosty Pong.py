...
class Board(object):
    ...
    def __init__(self, width, height):
        """
        Konstruktor planszy do gry. Przygotowuje okiengo gry.
    ...
    def draw(self, *args):
        ...
        for drawble in args:
            drawble.draw_on(self.surface)

        # dopiero w tym miejscu nastepuje faktyczne rysowanie
...
class PongGame(object):
    ...
    def handle_events(self):
        ...
        :return True jeżeli pygame przekazał zdarzenia wyjścia z gry
        """
...
class Ball(Drawable):
    """
    Piłeczkam sama kontoluje swoją prędkość i kierunek poruszania się.
    """
...
class Racket(Drawable):
    """
    Rakietka, porusza się w osi X z ogranicznikiem prędkośći
    """
...
class Judge(object):
    ...
    def __init__(self, board, ball, *args):
        ...
        # Przed pisaniem tekstów musimy zinicjować mechanizmy wyboru fontów PyGame
        pygame.font.init()
    ...
    def update_score(self, board_height):
        """
        Jeśli trzeba przyciela punkty i ustawia piłeczkę w początkowym położeniu
        """
    ...
    def draw_on(self, surface):
        """
        Aktualizuje i rysuje wynik
        """
        height = self.borad.surface.get_height()
        self.update_score(height)

        width = self.borad.surface.get_height()
...
# To część powinna być zawsze na końcu modułu (ten plik jest modułem)
# chcemy uruchomić naszą grę dopiero po tym jak wszystkie klasy zadeklarowane
