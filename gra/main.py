...
class Player:
    def __init__(self):
        ...
        self.y_cord = 0 # współrzędna x
        self.image = pygame.image.load("gracz.png") # wczytuję grafikę
...
class Cash:
    def __init__(self):
        ...
        self.image = pygame.image.load("smieci.png")
        self.width = self.image.get_width() # szerokość
        self.height = self.image.get_height() # wysokość
        self.hitbox = pygame.Rect(self.x_cord, self.y_cord, self.width, self.height)
...
def main():
    ...
    while run:
        ...
        score_image = pygame.font.Font.render(pygame.font.SysFont('arial', 48), f"Wynik: {score}", True, (255, 255, 255))
